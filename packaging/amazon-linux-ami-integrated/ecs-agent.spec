...
%global arch_tag %{nil}
%endif
%global ebs_csi_driver_tar ebs-csi-driver%{arch_tag}-v%{version}.tar
...
install -D %{ebs_csi_driver_tar} %{buildroot}%{ebs_csi_driver_dir}/ebs-csi-driver.tar
